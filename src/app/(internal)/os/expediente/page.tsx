...
export default function ExpedienteLabPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50/60 pb-20">
            {/* Staging Top Banner */}
            <div className="bg-gradient-to-r from-orange-600 via-[#f16315] to-amber-600 text-white px-4 py-2 text-center text-xs font-black uppercase tracking-widest shadow-sm flex items-center justify-center gap-2">
                <Sparkles size={14} />
                <span>🧪 Modo Laboratorio: Diagnóstico Clínico IA con Gemini 3.5 Flash Lite</span>
            </div>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <Link
                            ...
                            className="p-2 text-gray-500 hover:text-gray-800 hover:bg-gray-100 rounded-xl transition-all border border-gray-200 flex items-center gap-1 text-xs font-bold"
                        >
                            <ArrowLeft size={16} />
                        ...
                        <div>
                            <h1 className="text-base md:text-lg font-black text-gray-900 tracking-tight">
                                EXPEDIENTE CLÍNICO IA
                            </h1>
                            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">
                                CarMD OS • Staging Playground
                            </p>
                        </div>
                    </div>

                    <div className="flex items-center gap-2">
                        <span className="px-3 py-1 bg-orange-50 text-[#f16315] border border-orange-200 rounded-full text-[10px] font-black tracking-widest uppercase flex items-center gap-1">
                            <Cpu size={12} /> Gemini 3.5 Flash Lite
                        </span>
                    </div>
                </div>
            </header>
                ...
                <AnimatePresence>
                    {result && !loading && (
                        ...
                        >
                            ...
                            {/* ⭐ STAR COMPONENT: AI CLINICAL COPILOT (Gemini 3.5 Flash Lite) ⭐ */}
