...
1. 'respuesta_whatsapp': 
 ...
 3. 'cita_lista_para_resumen':
    ...
    - CORREO OBLIGATORIO: NUNCA pongas esto en \`true\` ni inventes "N/A" para el correo electrónico ('email') si el cliente aún no te lo ha proporcionado explícitamente en la conversación. Si falta el correo, mantén el campo 'email' como "...", pon 'cita_lista_para_resumen' en \`false\` y pídele amablemente su correo electrónico.
